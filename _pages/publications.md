...
{% assign publicationsByYear = site.publications | post.venue != "arXiv" | group_by_exp:"post", "post.date | date: '%Y'" %}
{% for year in publicationsByYear reversed %}
  <h1 style="margin: 1.5em 0px -0.5em; padding: 0px; color: brown;">{{ year.name }} - {{ year.size }}</h1>
